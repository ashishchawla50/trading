...
if(isset($_POST["SRNO"]) && isset($_POST["VOUCHERTYPE"]) && isset($_POST["tran-cashpayment"]))
{
	...
	?>
	<script>
		window.location.href='<?php echo SITEURL; ?>?tran-cashpayment-v';
	</script>
	<?php
	exit();
}
else
{
	...
	array_push($DebitCreditArr,"DR.RMBDOLSTATUS ");
	if(isset($_GET["_mid"]))
	{
		$action ="modify";
		$SRNO = $_GET["_mid"];
...
//$res_dr = getData(LEDGER_DEBIT,$DebitCreditArr,"  AS DR INNER JOIN ".LEDGER_CREDIT." AS CR ON CR.SRNO=DR.SRNO AND CR.VOUCHERTYPE=DR.VOUCHERTYPE WHERE CR.VOUCHERTYPE='Cash Payment' AND DR.VOUCHERTYPE='Cash Payment' ORDER BY DR.VOUCHERDATE DESC,DR.SRNO ASC");
$res_dr = getData(LEDGER_DEBIT,$DebitCreditArr,"  AS DR INNER JOIN ".LEDGER_CREDIT." AS CR ON CR.SRNO=DR.SRNO AND CR.VOUCHERTYPE=DR.VOUCHERTYPE WHERE CR.VOUCHERTYPE='Cash Payment' AND DR.VOUCHERTYPE='Cash Payment' ORDER BY DR.SRNO DESC");

?>
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Cash - Payment - Voucher - View</h1>
	</div>
	 <!-- /.col-lg-12 -->
</div>
<?php
...
<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-primary">
				 ...
				 <form name="frmacgrouptable" action="<?php echo SITEURL; ?>?tran-cashpayment-v" method="POST" onsubmit="return confirm('Do you really want to Delete?');">
								...
								while($resdata = mysqli_fetch_assoc($res_dr))
										{
											...
											?>
												...
												<td class="delcls">
													<a href="<?php echo SITEURL; ?>?cashpayment-view&_mid=<?php echo $resdata["SRNO"];?>" class="btn btn-primary btn-circle" title="Edit">
													...
													{	
													?>
													<a href="<?php echo SITEURL; ?>?tran-cashpayment-v&_rid=<?php echo $resdata["SRNO"];?>" onclick="return confirm('Do you really want to Delete This Transaction : <?php echo $resdata["SRNO"];?>?');" class="btn btn-danger btn-circle delcls" title="Delete">
													...
													<td style="text-align:right;"><?php echo getCurrFormat($resdata["AMOUNTDOLLAR"]);?></td>	
													<td style="text-align:left;"><?php echo $resdata["RMBAMOUNT"];?></td>		
				...
				<div class="panel-body">
					<p>
						...
						echo '
							...
							';
						?>
						<a  class="btn btn-success" href="<?php echo SITEURL; ?>?cashpayment-view" style="float:right;" ><i class="fa fa-tasks"></i> View All</a>
						<br>
					</p>
					<form id="frm_journaltable_edit" action="<?php echo SITEURL; ?>?tran-cashpayment-v" method="POST" >
						...
						<div class="form-group">
							<table width="100%" class="inputfieldtable">
								...
								<tr>
									...
									<td>
										<input type="text" class="form-control onlyNumber" name="txtRMBAMOUNT" id="txtRMBAMOUNT" value="<?php echo $resdata["RMBAMOUNT"]?>">
									</td>
								</tr>
