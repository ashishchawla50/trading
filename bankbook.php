...
if(isset($_POST["print-ledger"]) && !empty($_POST["txtLEDGERID"]))
{
	...
	/*if($MONEYCOL == "$")
	{
			array_push($CreditArr,"IF(CR.RMBDOLSTATUS=0,0,CR.AMOUNTDOLLAR) AS AMOUNT");
	...
	$res_dr = getData(LEDGER_DEBIT,$DebitArr,"  AS DR WHERE DR.LEDGERID='".$_POST["txtLEDGERID"]."' AND DR.VOUCHERDATE BETWEEN '".$dtfrm."' and '".$dtto."' ORDER BY DR.VOUCHERDATE");
	$res_cr = getData(LEDGER_CREDIT,$CreditArr,"  AS CR WHERE CR.LEDGERID='".$_POST["txtLEDGERID"]."' AND CR.VOUCHERDATE BETWEEN '".$dtfrm."' and '".$dtto."' ORDER BY CR.VOUCHERDATE ");
	...
	$DROPEN_AMT = getFieldDetail(LEDGER_DEBIT, "SUM(AMOUNT)", " WHERE LEDGERID='".$_POST["txtLEDGERID"]."' AND VOUCHERDATE <'".$dtfrm."'");
	$CROPEN_AMT = getFieldDetail(LEDGER_CREDIT, "SUM(AMOUNT)", " WHERE LEDGERID='".$_POST["txtLEDGERID"]."' AND VOUCHERDATE <'".$dtfrm."'");
	
	$DROPEN_USD = getFieldDetail(LEDGER_DEBIT, "SUM(AMOUNTDOLLAR)", " WHERE LEDGERID='".$_POST["txtLEDGERID"]."' AND VOUCHERDATE <'".$dtfrm."'");
	$CROPEN_USD = getFieldDetail(LEDGER_CREDIT, "SUM(AMOUNTDOLLAR)", " WHERE LEDGERID='".$_POST["txtLEDGERID"]."' AND VOUCHERDATE <'".$dtfrm."'");
	
	$DROPEN_RMB = getFieldDetail(LEDGER_DEBIT, "SUM(RMBAMOUNT)", " WHERE LEDGERID='".$_POST["txtLEDGERID"]."' AND VOUCHERDATE <'".$dtfrm."'");
	$CROPEN_RMB = getFieldDetail(LEDGER_CREDIT, "SUM(RMBAMOUNT)", " WHERE LEDGERID='".$_POST["txtLEDGERID"]."' AND VOUCHERDATE <'".$dtfrm."'");
...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Bank Book</h1>
	</div>
	 <!-- /.col-lg-12 -->
</div>
								...
								<tr>
									...
									<td colspan ="2">
											 ...
											 <select class="form-control" name="txtLEDGERID" id="txtLEDGERID">
												...
												<?php
												$res_led = getData(LEDGER,$AllArr," WHERE FLAG='0' AND GROUPID='1,2'");
