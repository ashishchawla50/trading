...
$AMOUNT =$_POST["txtCRAMOUNT"];
	...
	?>
	<script>
		window.location.href='<?php echo SITEURL; ?>?tran-bankpayment-sale-v';
	</script>
	<?php
	exit();
}
...
//$res_dr = getData(LEDGER_DEBIT,$DebitCreditArr,"  AS DR INNER JOIN ".LEDGER_CREDIT." AS CR ON CR.SRNO=DR.SRNO AND CR.VOUCHERTYPE=DR.VOUCHERTYPE WHERE CR.DOLLARSALE=1 AND DR.DOLLARSALE=1 ORDER BY DR.VOUCHERDATE DESC,DR.SRNO ASC");
$res_dr = getData(LEDGER_DEBIT,$DebitCreditArr,"  AS DR INNER JOIN ".LEDGER_CREDIT." AS CR ON CR.SRNO=DR.SRNO AND CR.VOUCHERTYPE=DR.VOUCHERTYPE WHERE CR.DOLLARSALE=1 AND DR.DOLLARSALE=1 ORDER BY DR.SRNO DESC");

?>
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Bank - Payment - Sale - Voucher - View</h1>
	</div>
	 <!-- /.col-lg-12 -->
</div>
<?php
...
<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-primary">
				 ...
				 <p>
						<a  class="btn btn-warning" href="<?PHP echo SITEURL.'?tran-bankpayment-sale';?>" style="float:right;" ><i class="fa fa-backward"></i> Back</a>
						<br>
					</p>
				 <BR>
				 <form name="frmacgrouptable" action="<?php echo SITEURL; ?>?bankpayment-sale-view" method="POST" onsubmit="return confirm('Do you really want to Delete?');">
								...
								while($resdata = mysqli_fetch_assoc($res_dr))
										{
											...
											?>
												...
												<td class="delcls">
													<!--<a href="<?php echo SITEURL; ?>?tran-bankpayment-v&_mid=<?php echo $resdata["SRNO"];?>" class="btn btn-primary btn-circle" title="Edit">
													...
													{	
													?>
													<a href="<?php echo SITEURL; ?>?tran-bankpayment-sale-v&_rid=<?php echo $resdata["SRNO"];?>" onclick="return confirm('Do you really want to Delete This Transaction : <?php echo $resdata["SRNO"];?>?');" class="btn btn-danger btn-circle delcls" title="Delete">
