<?php
if(isset($_POST["tran-bankpayment"]))
{
	$idarr = array();
		...
		foreach($idarr as $id)
		{
			if($amt > 0 )
			{
				...
				else
				{
					...
					array_push($tranValueArr,"'".$conv_rmb."'");
					array_push($tranValueArr,"'".$AMOUNT_rmb."'");
					array_push($tranValueArr,"'".(isset($_POST["txtCOMMISSIONPER"]) ? $_POST["txtCOMMISSIONPER"] : 0)."'");
					array_push($tranValueArr,"'".(isset($_POST["txtCOMMISSIONAMT"]) ? $_POST["txtCOMMISSIONAMT"] : 0)."'");
	...
	//	window.location.href="<?php echo SITEURL."?tran-bankpayment";?>";
		</script>
		<?php
		exit();
}
...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Bank - Payment - Voucher</h1>
	</div>
	 <!-- /.col-lg-12 -->
</div>
		...
		<div class="col-lg-12">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					?>
					<p>
						<a  class="btn btn-warning" href="<?php echo SITEURL; ?>?bankpayment-view" style="float:right;" ><i class="fa fa-tasks"></i> View All</a>
						<br>
					</p>
					<?php
					}
					?>
					<form id="tran-bankpayment" action="<?php echo SITEURL; ?>?tran-bankpayment" method="POST">
