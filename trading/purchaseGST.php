...
if(isset($_POST["print-purchasegst"]))
{
	...
	$res_dr = getData(PURCHASESALE,$PurchasegstArr,"  AS P INNER JOIN ".LEDGER." AS L ON L.LEDGERID=P.LEDGERID  WHERE P.VOUCHERTYPE='Purchase' AND P.BILLSTATUS='With Bill'  AND P.VOUCHERDATE BETWEEN '".$dtfrm."' and '".$dtto."' ");
...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Purchase GST</h1>
	</div>
	 <!-- /.col-lg-12 -->
</div>
<?php
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-primary">
				 ...
				 <form name="frmledgertable" id="frmledgertable" action="<?php echo SITEURL; ?>?print-purchasegst" method="POST">
					...
					<div class="form-group">
							...
							<div class="form-group">
								<button type="submit" class="btn btn-default" style="float: right;margin-left:10px;" name="print-purchasegst" id="printledger">Submit Button</button>
								<button type="submit" class="btn btn-danger" style="float: right;" name="print-purchasegst-pdf" id="printledgerpdf"><i class="fa fa-file-pdf-o"></i> Make PDF</button>
								<br/><br>
								</div>
						</div>
