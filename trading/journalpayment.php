...
if(isset($_POST["tran-journalpayment"]))
{
	...
	else
	{
		...
		window.location.href="<?php echo SITEURL."?tran-journalpayment";?>";
		</script>
		<?php
		exit();
}
...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Journal - Payment - Voucher</h1>
	</div>
	 <!-- /.col-lg-12 -->
</div>
		...
		<div class="col-lg-12">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					?>
					<form id="tran-cashpayment" action="<?php echo SITEURL; ?>?tran-journalpayment" method="POST">
