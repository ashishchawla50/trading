<?php
if(isset($_POST["tran-cashreceipt"]))
{
	$idarr = array();
	...
	if(count($idarr) == 1 )
	{
		...
		array_push($tranValueArr,"'Cash Receipt'");
	...
	else
	{
		...
		<script>
			...
			window.location.href="<?php echo SITEURL."?tran-cashreceipt";?>";
		</script>
		<?php
		exit();
}
		...
		<div class="col-lg-12">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					?>
					<form id="tran-cashreceipt" action="<?php echo SITEURL; ?>?tran-cashreceipt" method="POST">
