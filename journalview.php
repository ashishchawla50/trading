<?php
if(isset($_POST["SRNO"]) && isset($_POST["VOUCHERTYPE"]) && isset($_POST["tran-journal"]))
{
	...
	?>
	<script>
		window.location.href='<?php echo SITEURL; ?>?tran-journal-v';
	</script>
	<?php
	exit();
}
else
{
	...
	if(isset($_GET["_mid"]))
	{
		...
		$Caption = "Edit Journal Voucher Detail";
		$res = getData(LEDGER_DEBIT,$DebitCreditArr,"  AS DR INNER JOIN ".LEDGER_CREDIT." AS CR ON CR.SRNO=DR.SRNO AND CR.VOUCHERTYPE=DR.VOUCHERTYPE WHERE CR.VOUCHERTYPE='Journal' AND DR.VOUCHERTYPE='Journal' AND DR.SRNO='".$SRNO."' AND CR.SRNO='".$SRNO."'");
...
$res_dr = getData(LEDGER_DEBIT,$DebitCreditArr,"  AS DR INNER JOIN ".LEDGER_CREDIT." AS CR ON CR.SRNO=DR.SRNO AND CR.VOUCHERTYPE=DR.VOUCHERTYPE WHERE CR.VOUCHERTYPE='Journal' AND DR.VOUCHERTYPE='Journal'");

?>
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Journal - Voucher - View</h1>
	</div>
	 <!-- /.col-lg-12 -->
</div>
<?php
...
<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-primary">
				 ...
				 <form name="frmacgrouptable" action="<?php echo SITEURL; ?>?tran-journal-v" method="POST" onsubmit="return confirm('Do you really want to Delete?');">
								...
								while($resdata = mysqli_fetch_assoc($res_dr))
										{
											...
											?>
												...
												<td class="delcls">
													<!--<a href="<?php echo SITEURL; ?>?tran-journal-v&_mid=<?php echo $resdata["SRNO"];?>" class="btn btn-primary btn-circle" title="Edit">
													...
													{	
													?>
													<a href="<?php echo SITEURL; ?>?tran-journal-v&_rid=<?php echo $resdata["SRNO"];?>" onclick="return confirm('Do you really want to Delete This Transaction : <?php echo $resdata["SRNO"];?>?');" class="btn btn-danger btn-circle delcls" title="Delete">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<p>
						<a  class="btn btn-warning" href="<?php echo SITEURL; ?>?tran-journal-v" style="float:right;" ><i class="fa fa-tasks"></i> View All</a>
						<br>
					</p>
					<form id="frm_journaltable_edit" action="<?php echo SITEURL; ?>?tran-journal-v" method="POST" >
						...
						<button type="submit" class="btn btn-default" style="float: right;" name="tran-journal">Submit Button</button>
					</form>
				</div>
			</div>
		</div>
